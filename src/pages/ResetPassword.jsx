...
export default function ResetPasswordPage() {
  ...
  <div className="relative">
    <input
      ...
      className="w-full border border-stone-line bg-white/60 px-3 py-2 pr-10 text-sm text-ink focus:border-brass outline-none"
      placeholder="••••••••"
    />
    <button
      type="button"
      onClick={() => setShowPassword((v) => !v)}
      className="absolute right-2 top-1/2 -translate-y-1/2 text-ink-soft hover:text-brass transition-colors"
      tabIndex={-1}
